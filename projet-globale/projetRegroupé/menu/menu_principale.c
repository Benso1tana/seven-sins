...
M->jouer1[0] = IMG_Load("jouer1.png");
M->jouer1[1] = IMG_Load("jouer2.png");

M->option1[0]= IMG_Load("option1.png");
M->option1[1]=IMG_Load("option2.png");

M->meilleurs1[0]=IMG_Load("meilleurs1.png");
M->meilleurs1[1]=IMG_Load("meilleurs2.png");

M->historique1[0]=IMG_Load("historique1.png");
M->historique1[1]=IMG_Load("historique2.png");

M->quitter1[0]=IMG_Load("quitter1.png");
M->quitter1[1]=IMG_Load("quitter2.png");
...
M->bg_option=IMG_Load("option/bg4.png");

M->option_augmenter[0]=IMG_Load("option/augmenter1.png");
M->option_augmenter[1]=IMG_Load("option/augmenter2.png");

M->option_diminuer[0]=IMG_Load("option/diminuer1.png");
M->option_diminuer[1]=IMG_Load("option/diminuer2.png");

M->option_normale[0]=IMG_Load("option/normal1.png");
M->option_normale[1]=IMG_Load("option/normal2.png");

M->option_plein[0]=IMG_Load("option/plein1.png");
M->option_plein[1]=IMG_Load("option/plein2.png");
M->retour[0]=IMG_Load("option/retour1.png");
M->retour[1]=IMG_Load("option/retour2.png");
...
M->bg_sauvegarde_charg[0]=IMG_Load("Sauv&charg/bg3.png");
M->bg_sauvegarde_charg[1]=IMG_Load("Sauv&charg/bg6.png");//s_s chargement

M->bouton_oui[0]=IMG_Load("Sauv&charg/oui1.png");
M->bouton_oui[1]=IMG_Load("Sauv&charg/oui2.png");

M->bouton_non[0]=IMG_Load("Sauv&charg/non1.png");
M->bouton_non[1]=IMG_Load("Sauv&charg/non2.png");

M->bouton_charger[0]=IMG_Load("Sauv&charg/charger1.png");
M->bouton_charger[1]=IMG_Load("Sauv&charg/charger2.png");

M->bouton_nouvelle[0]=IMG_Load("Sauv&charg/nouvelle1.png");
M->bouton_nouvelle[1]=IMG_Load("Sauv&charg/nouvelle2.png");
...
M->bg_M_joueur[0]=IMG_Load("M_joueur/bg7.png");
M->bg_M_joueur[1]=IMG_Load("M_joueur/bg5.png");

M->bouton_mono[0]=IMG_Load("M_joueur/mono1.png");
M->bouton_mono[1]=IMG_Load("M_joueur/mono2.png");

M->bouton_multi[0]=IMG_Load("M_joueur/multi1.png");
M->bouton_multi[1]=IMG_Load("M_joueur/multi2.png");
...
M->bouton_j1[0]=IMG_Load("M_joueur/haclia1.png");
M->bouton_j1[1]=IMG_Load("M_joueur/haclia2.png");

M->bouton_j2[0]=IMG_Load("M_joueur/haclios1.png");
M->bouton_j2[1]=IMG_Load("M_joueur/haclios2.png");

M->bouton_valider[0]=IMG_Load("M_joueur/valider1.png");
M->bouton_valider[1]=IMG_Load("M_joueur/valider2.png");

M->bouton_retour_1[0]=IMG_Load("M_joueur/retour1.png");
M->bouton_retour_1[1]=IMG_Load("M_joueur/retour2.png");
...
M->bg_meilleur_s[0]=IMG_Load("meilleur_score/bgg1.png");
M->bg_meilleur_s[1]=IMG_Load("meilleur_score/bgg2.png");

M->bouton_valider_1[0]=IMG_Load("meilleur_score/v1.png");
M->bouton_valider_1[1]=IMG_Load("meilleur_score/v2.png");
...
M->arial=TTF_OpenFont("arial.ttf",38);
if (M->arial==NULL)
    {
        printf("Erreur chargement image : %s\n", TTF_GetError());
     }
...
M->bouton_quitter_2[0]=IMG_Load("meilleur_score/quitter1.png");
M->bouton_quitter_2[1]=IMG_Load("meilleur_score/quitter2.png");

M->bouton_retour_2[0]=IMG_Load("meilleur_score/retour1.png");
M->bouton_retour_2[1]=IMG_Load("meilleur_score/retour2.png");
